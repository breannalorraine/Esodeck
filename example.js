...
setTimeout(function () {
  printMessage('Ask a question related to your life on the web')
}, randomDelay)

setTimeout(function () {
  printMessage('...or your life in general')
}, randomDelay + 5000)

setTimeout(function () {
  printMessage('...pick a card, select the link to the booklet and have fun ;)')
}, randomDelay + 10000)
